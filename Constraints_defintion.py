...
def generate_prolog_file(total_teams, availabilities, filename):
...
def main():
    input_dir = '/home/asus/Téléchargements/work2/Non-Commercial-Indoor-Football-Instances/Non-Commercial-Indoor-Football-Instances-Website/Instances'
    output_dir = '/home/asus/Téléchargements/work2/Non-Commercial-Indoor-Football-Instances/Non-Commercial-Indoor-Football-Instances-Website/Output_Instances/'
    ...
    for filename in os.listdir(input_dir):
        if filename.endswith('.txt'):
            ...
            generate_prolog_file(total_teams, availabilities, filename)
